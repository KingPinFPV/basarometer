        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4 rtl:space-x-reverse">
            <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse group">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">בשרומטר V5.1</h1>
                <p className="text-xs text-white/80">פלטפורמת קניות חכמה</p>
              </div>
            </Link>
          </div>
          ...
          <div className="absolute top-16 right-0 left-0 bg-white shadow-lg border-t border-gray-200 z-50 md:hidden animate-fade-in">
            <nav className="px-4 py-4 space-y-2">
              ...
              <div className="px-3 py-3">
                <div className="bg-blue-50 text-blue-700 px-3 py-2 rounded-md text-sm font-medium border border-blue-200">
                  <div className="flex items-center space-x-2 rtl:space-x-reverse">
                    <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
                    <span>V5.1 - פלטפורמה חכמה</span>
                  </div>
                </div>
              </div>
            </nav>
